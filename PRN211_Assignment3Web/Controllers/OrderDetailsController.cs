...
namespace PRN211_Assignment3Web.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(Prn211Assignment3Context context)
        {
            _context = context;
        }
    ...
    .Include(o => o.Order.User);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,OrderId,ProductId,UnitStock,UnitPrice")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailId,OrderId,ProductId,UnitStock,UnitPrice")] OrderDetail orderDetail)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Prn211Assignment3Context.OrderDetails'  is null.");
            }
            var orderDetail = await _context.OrderDetails.FindAsync(id);
            if (orderDetail != null)
            {
